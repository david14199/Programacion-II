...
class login1(tk.Tk):
    ...
    def __init__(self):
        ...
        self.label_imagen = tk.Label(self.frame_imagen, bg="black")
    ...
    def cargar_imagen(self):
        path_imagen = Image.open("imagenes/inicio-img.png")
        icono_imagen = ImageTk.PhotoImage(path_imagen)
        self.label_imagen.configure(image=icono_imagen)
        self.label_imagen.image = icono_imagen
    def registro1(self):
        app = Registro()
        self.destroy()
        app.mainloop()
