...
class Registro(tk.Tk):
    ...
    def __init__(self):
        ...
        self.FONDO = utl.leer_imagen(r"imagenes/fondo-bosque.jpg", (824, 650))
        self.FONDO1=tk.Label(self,image=self.FONDO)
        self.FONDO1.place(x=0,y=0)
        # Titulos guias
        ...
        self.nombre1r = tk.Entry(self, width=35, font=20, bg="black", foreground="white", border=0)
        self.nombre1r.place(x=200, y=194, height=22)
        self.apellido1r = tk.Entry(self, width=35, font=20, bg="black", foreground="white", border=0)
        ...
        self.nombre_de_usuario1r = tk.Entry(self, width=35, font=20, bg="black", foreground="white", border=0)
        self.nombre_de_usuario1r.place(x=200, y=374, height=22)
        self.clave1r = tk.Entry(self, width=35, font=20, bg="black", foreground="white", border=0, show="*")
        ...
        self.botonr2 = tk.Button(self, text="Atras", command="", font=("Cooper Black", 18), border=5,padx=25)
